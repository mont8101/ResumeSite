...
return(
    <nav className=' bg-white dark:bg-gray-950 fixed w-full z-20 top-0 start-0 border-b-1 border-gray-200 dark:border-gray-600'>
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between md:justify-center mx-auto p-4">
            <div className='flex flex-col visible md:hidden'>
                <a href="https://linkedin.com/in/ben-m" className="flex items-center space-x-3 rtl:space-x-reverse">
                    <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Ben Montgomery</span>
                </a>
                <div className='self-center text-l font-semibold whitespace-nowrap dark:text-gray-400'>
                    Software Consultant
                </div>
            </div>
            ...
            <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1">
                <button onClick={() => scrollToSection("About")} className="relative inline-flex items-center justify-center p-0.5 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800">
                    <span className="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-950 rounded-md group-hover:bg-transparent group-hover:dark:bg-transparent">
                        About
                    </span>
                </button> 
                <button onClick={() => scrollToSection("Projects")} className="relative inline-flex items-center justify-center p-0.5 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-blue-500 to-cyan-500 group-hover:from-blue-500 group-hover:to-cyan-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-cyan-200 dark:focus:ring-cyan-800">
                    <span className="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-950 rounded-md group-hover:bg-transparent group-hover:dark:bg-transparent">
                        Project Summary
                    </span>
                </button>
                <button onClick={() => scrollToSection("Contact")} className="relative inline-flex items-center justify-center p-0.5 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-cyan-500 to-green-400 group-hover:from-cyan-500 group-hover:to-green-400 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800">
                    <span className="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-950 rounded-md group-hover:bg-transparent group-hover:dark:bg-transparent">
                        Contact
                    </span>
                </button>
