...
export default function About(){
    ...
    return(
        <div id='About' className='grid grid-cols-1 md:grid-cols-2 items-center justify-center px-4 md:px-0'>
            <div className='flex flex-col col border-white border-1 rounded-lg p-4 mr-4 mb-4 md:mb-0 max-w-96 w-full md:h-72 shadow-surround shadow-gray-600 dark:shadow-cyan-500 transition-all duration-200 hover:shadow-cyan-300'>
                <div className='flex flex-row dark:text-white font-bold text-3xl items-center pb-2'>
            ...
            <div className='flex flex-col border-black dark:border-white border-1 rounded-lg p-4 mr-1 max-w-96 md:h-72 shadow-surround shadow-cyan-500 transition-all duration-200 hover:shadow-cyan-300'>
                <div className='flex flex-row dark:text-white font-bold text-3xl items-center pb-2'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
